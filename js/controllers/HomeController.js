app.controller('HomeController', ['$scope', function($scope) {
	...
	*/
    ...
    { 
      ...
      rating:	'R',
      runtime:	195,
      released:	new Date('1997', '02', '28'),
      country:	'USA',
      posters:	['img/donniebrasco.jpg','img/donniebrasco2.jpg','img/donniebrasco3.jpg'],
      imdb:		'https://www.imdb.com/title/tt0119008/',
      website:	'https://en.wikipedia.org/wiki/Donnie_Brasco_(film)',
      likes:	309,
      dislikes:	210,
      posterindex: 0
	},
    { 
      ...
      country:	'USA',
      posters:	['img/goodfellas.jpg','img/goodfellas2.jpg','img/goodfellas3.jpg'],
    ...
    { 
      ...
      rating:	'R',
      runtime:	178,
      released:	new Date('1995', '09', '22'),
      country:	'USA',
      posters:	['img/casino.jpg','img/casino2.jpg','img/casino3.jpg'],
      imdb:		'https://www.imdb.com/title/tt0112641/',
      website:	'https://en.wikipedia.org/wiki/Casino_(film)',
      likes:	927,
      dislikes:	100,
      posterindex: 0
	}
	...
	$scope.title = "IMDB + Todd's Top 8 Movies";
    $scope.owner = "Todd";
